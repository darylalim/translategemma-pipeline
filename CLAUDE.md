...
- Full-width button row `[3, 1, 14, 1, 1]` below content columns — translate button (primary, left), clear button (`:material/close:`), copy button (`:material/content_copy:`), download button (`:material/download:`, right-aligned)
